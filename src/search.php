...
class SynoDLMSearchTorrentKim {
	...
	public function parse($plugin, $response) {
		...
		$response = preg_replace("/<description><\/description>/i", "<description><![CDATA[Category: All<br />Subcategory: All<br />Size: 100&nbsp;kilobyte<br />Ratio: 1 seeds, 0 leechers<br />Language: Unknown<br />Uploaded by: Unknown]]></description>", $response);
